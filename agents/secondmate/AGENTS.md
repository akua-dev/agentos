...
- Load `$agentos-upgrade` only for an exactly authorized stable self-update or rollback; route Fleet-wide selection and other-Mate updates through First Mate.
